...
******************************************************************************/
void Paint_DrawPoint( uint32_t Xpoint, uint32_t Ypoint, uint32_t Color, DOT_PIXEL Dot_Pixel, DOT_STYLE Dot_Style )
{
    int16_t XDir_Num = 0;
    int16_t YDir_Num = 0;
...
******************************************************************************/
void Paint_DrawLine( uint32_t Xstart, uint32_t Ystart, uint32_t Xend, uint32_t Yend, uint32_t Color,
...
******************************************************************************/
void Paint_DrawRectangle( uint32_t Xstart, uint32_t Ystart, uint32_t Xend, uint32_t Yend, uint32_t Color,
...
******************************************************************************/
void Paint_DrawCircle( uint32_t X_Center, uint32_t Y_Center, uint32_t Radius, uint32_t Color, DOT_PIXEL Line_width,
                       DRAW_FILL Draw_Fill )
{
...
parameter:
    ...
    Color_Background : Select the background color
******************************************************************************/
void Paint_DrawString_EN( uint32_t Xstart, uint32_t Ystart, const char* pString, const sFONT* Font,
                          uint32_t Color_Foreground, uint32_t Color_Background )
{
    uint32_t Xpoint = Xstart;
    uint32_t Ypoint = Ystart;
...
void Paint_DrawNum( uint32_t Xpoint, uint32_t Ypoint, double Nummber, sFONT* Font, uint32_t Digit,
                    uint32_t Color_Foreground, uint32_t Color_Background )
{
                    ...
                    uint32_t Color_Foreground, uint32_t Color_Background)
{
    ...
    char buf[22];
    sprintf(buf,"%02d:%02d:%02dUTC-%02d/%02d/%02d", pTime->Hour, pTime->Min, pTime->Sec, pTime->Day, pTime->Month,
    (int) pTime->Year); Paint_DrawString_EN(Xstart , Ystart, buf, Font, Color_Background, Color_Foreground);
    ...
    Color_Foreground);
    // Paint_DrawChar(Xstart + Dx * 7                  , Ystart, value[pTime->Day / 10] , Font, Color_Background,
    Color_Foreground);
    // Paint_DrawChar(Xstart + Dx * 8                  , Ystart, value[pTime->Day % 10] , Font, Color_Background,
    Color_Foreground);
    // Paint_DrawChar(Xstart + Dx * 9                  , Ystart, value[pTime->Month / 10] , Font, Color_Background,
    Color_Foreground);
    // Paint_DrawChar(Xstart + Dx * 10                  , Ystart, value[pTime->Month % 10] , Font, Color_Background,
    Color_Foreground);
    // Paint_DrawChar(Xstart + Dx * 11                  , Ystart, value[pTime->Year / 10] , Font, Color_Background,
    Color_Foreground);
    // Paint_DrawChar(Xstart + Dx * 12                  , Ystart, value[pTime->Year % 10] , Font, Color_Background,
    Color_Foreground);
...
void Paint_DrawImage1( const unsigned char* image, uint32_t xStart, uint32_t yStart, uint32_t W_Image,
                       uint32_t H_Image )
{
    uint32_t i = 0;
    uint32_t j = 0;
...
void Paint_BmpWindows( unsigned char x, unsigned char y, const unsigned char* pBmp, unsigned char chWidth,
