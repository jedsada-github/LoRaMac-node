...
void GpsMcuInit( void )
{
    ...
    GpioInit( &Gps3dFix, GPS_3DFIX, PIN_INPUT, PIN_PUSH_PULL, PIN_NO_PULL, 0 );
    // GpioSetInterrupt( &Gps3dFix, IRQ_FALLING_EDGE, IRQ_VERY_LOW_PRIORITY, &GpsMcuOnPpsSignal );
