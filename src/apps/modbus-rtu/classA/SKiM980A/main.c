    ...
    case 3:
        {
            ...
            //TODO: Prepare CH value from Modbus;
            
            for(int i = 0; i < NUMBER_MASTER_INPUT_REGISTERS; i++)
            {
                /* code */
                AppDataBuffer[i + 4] = MasterRegisterInputs[i].ActValue;
            }
...
static void McpsIndication( McpsIndication_t *mcpsIndication )
{
    ...
    if( mcpsIndication->RxData == true )
    {
        ...
        case 2:
            ...
            break;
        case 3:
            //TODO: modbus master write
            // slave address, function, start address,  number of data, *data
                modbus_slave.address = mcpsIndication->Buffer[0];
                modbus_slave.function = mcpsIndication->Buffer[1];
                modbus_slave.start_address = mcpsIndication->Buffer[2];
                modbus_slave.start_address = mcpsIndication->Buffer[3
